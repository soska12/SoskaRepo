...
@class WATodayPadViewStyle; @class SBFLockScreenDateView; @class WATodayPadView; @class SBLockScreenDateViewController; 
...
__attribute__((used)) static WALockscreenWidgetViewController * _logos_method$_ungrouped$SBLockScreenDateViewController$weatherController(SBLockScreenDateViewController * __unused self, SEL __unused _cmd) { return (WALockscreenWidgetViewController *)objc_getAssociatedObject(self, (void *)_logos_method$_ungrouped$SBLockScreenDateViewController$weatherController); }; __attribute__((used)) static void _logos_method$_ungrouped$SBLockScreenDateViewController$setWeatherController(SBLockScreenDateViewController * __unused self, SEL __unused _cmd, WALockscreenWidgetViewController * rawValue) { objc_setAssociatedObject(self, (void *)_logos_method$_ungrouped$SBLockScreenDateViewController$weatherController, rawValue, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
